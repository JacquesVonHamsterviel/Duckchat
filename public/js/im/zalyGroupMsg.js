...
$(document).on("click", ".changemore", function () {
    $(".input-tools").toggleClass("active");
});
//------------------------------------*********Group function*********--------------------------------------------
...
$(document).on("click", ".right-input", function(){
    // smile 点击消息列表顶上
    console.log("消息输入框-获取焦点");
    setTimeout(function(){fx();}, 200);
});
// //消息输入框-失去焦点
// $(document).on("click", ".right-chatbox", function(){
//     $("body").height("100%");
// });
// $(document).on("blur", ".input-box-text", function(){
//     $("body").height("100%");
// });
//返回
$(document).on("click", ".history_back", function(){
    $(".msg-chat-dialog")[0].style.display = "none";
    // $(".layout-left").style.display = "block";
    $(".layout-left").show();
    $(".friend-apply-dialog")[0].style.display = "none";
});

// 辅助
var chu_body_height = document.body.clientHeight;
...
function fx() {
    ...
    // if ($(".right-chatbox")[0].scrollHeight == 0) {
    //     $(".right-chatbox").scrollTop(0);
    // }else{
    // }

    msgBoxScrollToBottom();
    //
    // var body_height = chu_body_height - document.body.scrollTop; //367
    //
    // if (body_height < chu_body_height) {
    //     $("body").height(body_height);
    // }
    //
    // $("body").scrollTop(0);
    // $(".input-box-text").text("222"+document.body.scrollTop);



}
// setInterval(function(){$(".right-chatbox").scrollTop(0);},1000);
// setInterval(function(){$(".right-chatbox").scrollTop($(".right-chatbox")[0].scrollHeight);},1000);
// $(".input-box-text").text("111"+document.body.clientHeight);


// 用户广场
$(document).on("click", ".pw-home-row-name", function(){
    $('.layout-left').hide();
    $(".plugin-list-dialog")[0].style.display = "block";
});

$(document).on("click", ".contact-row-group-profile,.contact-row-u2-profile", function(){
    $('.layout-left').hide();
    $(".msg-chat-dialog")[0].style.display = "block";
});

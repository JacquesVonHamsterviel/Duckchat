...
<div class="right-head">
    <img src="./public/img/back.png"  class="history_back"/>
        ...
        <div class="right-input">
                <div class="input-box">
                    ...
                    <div class="input-btn" style="display: flex;">
                        <img src="./public/img/msg/emotions.png" class="emotions" style="margin-right: .8rem;"/>
                        <img src="./public/img/WechatIMG375.png" class="changemore" style="margin-right: .8rem;"/>
                        <button class="send_msg" data-local-value="sendTip" style="">发送</button>
                    </div>
                    <div id="emojies" style="display: none;position: absolute; bottom:100%">
            ...
            <div class="input-tools">
                ...
                <img src="./public/img/msg/file.png" onclick="uploadFile('file3')" class="upload-img" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg"/>
                <input type="file" id="file3" style="display:none" onchange="uploadMsgFileFromInput(this, FileType.FileDocument)">
                <div class="input-plugin-tools" style="display: inline-block;">
                </div>
            </div>
        </div>
    </div>
